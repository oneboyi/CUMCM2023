...
\keywords{\quad 局部最优调整\quad 多波束测深\quad 测线规划\quad 正弦定理\quad 几何关系 \quad 平面几何}
\end{abstract}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=1.2\textwidth]{wenti2}
    \caption{立体海床图}
...
参考文献\cite[text1]{liuhaiyang2013latex}对于一篇正式的论文来说是\cite[text2]{mathematical-modeling}必不可少的，在建模中重要的参考文献当然应该列出。\LaTeX{}在这方面的功能也是十分强大的，下面进介绍一个比较简单的参考文献制作方法。有兴趣的可以学习 \verb|bibtex| 或 \verb|biblatex| 的使用。
